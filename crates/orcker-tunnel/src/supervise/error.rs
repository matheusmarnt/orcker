...
//! service id): [`ExitReason`] classifies how a supervised child exited and
//! [`SpawnFailureReason`] classifies why a spawn or wait failed.
...
/// [`crate::supervise::traits::ProcessSpawner::spawn`] or by
/// [`crate::supervise::traits::ChildHandle::wait`] during supervision.
///
