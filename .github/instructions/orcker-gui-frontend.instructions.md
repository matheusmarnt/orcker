---
applyTo: "apps/orcker-gui/src/**/*.{vue,ts}"
---

# orcker-gui frontend — Vue 3 + TypeScript + Tailwind
...
- Keep the wire types in `src/ipc/types.ts` aligned with the Rust `orcker-ipc`
