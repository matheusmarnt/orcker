...
| R-M1.1 | Phase 2 | Complete |
| R-M1.2 (Redis/PG/Mailpit) | Phase 2 | Pending |
| R-M1.2 (MinIO/Soketi/Meilisearch) | Phase 4 | Pending |
| R-M1.3 | Phase 2 | Complete |
| R-M1.4 | Phase 2 | Complete |
| R-M1.5 | Phase 2 | Complete |
| R-M2.1 | Phase 3 | Complete |
| R-M2.2 | Phase 3 | Complete |
| R-M2.3 (TALL/Inertia) | Phase 3 | Pending |
| R-M2.3 (Filament/API/Jetstream) | Phase 4 | Pending |
| R-M2.4 | Phase 3 | Complete |
| R-M2.5 | Phase 3 | Complete |
| R-M2.6 | Phase 3 | Complete |
| R-M2.7 | Phase 3 | Complete |
| R-M2.8 | Phase 3 | Complete |
| R-M2.9 | Phase 3 | Complete |
| R-M2.10 | Phase 3 | Complete |
| R-M3.1 | Phase 3 | Complete |
| R-M3.2 | Phase 3 | Complete |
| R-M3.3 | Phase 3 | Complete |
| R-M3.4 | Phase 4 | Complete |
| R-M3.5 | Phase 4 | Complete |
| R-M4.1 | Phase 3 | Complete |
...
| R-M6.3 | Phase 4 | Complete |
| R-M6.4 | Deferred (Phase G+) | Out of scope |
| R-M7.1 | Phase 4 | Complete |
| R-M7.2 | Phase 4 | Complete |
| R-M7.3 | Phase 4 | Complete |
| R-M7.4 | Phase 4 | Complete |
| R-M7.5 | Phase 4 | Complete |
| R-M7.6 | Phase 4 | Complete |
...
| RNF-04 | Phase 3 | Complete |
| RNF-05 | Phase 3/4/5 (progressive) | Complete |
